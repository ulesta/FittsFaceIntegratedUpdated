    ...
    public void onPreviewFrame(byte[] data, Camera arg1) {
        ...
        if (numFaces == 0) {
            ...
            if (drawView != null) {
                ...
                drawView = DrawView.getInstance(this, null, false, 0, 0, null, landScapeMode, null, "");
            ...
            if (faceArray == null) {
                ...
                preview.removeView(gameDrawView);
                drawView = DrawView.getInstance(this, faceArray, true, surfaceWidth, surfaceHeight, cameraObj, landScapeMode, null, "");
